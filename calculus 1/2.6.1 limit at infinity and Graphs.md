...
$$
avoid the possibility of $r<0$ because a negative exponent would flip the graph upside down, reflecting it across the x-axis. Additionally, since the function would no longer represent exponential growth or decay in the usual sense, it may not fit the intended interpretation it would product a decressing curve or a constant value depending on the context 
