...
\tan \left(  \frac{15\pi}{4} \right) = \tan \left(  \frac{7}{4}\pi  +  2\pi \right)   =  \tan \left( -\frac{1}{4}\pi   +  2\pi \right)     \text{ the angle will spin  around one time because of the coterminal angle   }  \\
 \tan \left(  
 \\ 
\end{array}
$$
