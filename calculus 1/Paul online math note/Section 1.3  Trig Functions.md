---
title: Adjunction
references: https://tutorial.math.lamar.edu/Classes/CalcI/TrigFcns.aspx
tags:
  - In_Progress
...
\begin{array}{l}  \\
\tan\left( - \frac{\pi}{4}  \right) \cap  \tan \left( \frac{7\pi}{4}\right)   \\
\tan\left( - \frac{\pi}{4}  \right)  =   \tan \pi +  \frac{\pi}{6}  \text{ we will rotated it so that it lose the negative notaiton}  \\
\frac{7\pi}{4 }  =  2\pi - \frac{\pi}{4} \in \text{bases on the   }  \frac{\pi}{4}  \\
...
\sin  =  \frac{1}{2}   \\
\cos  = \frac{\sqrt{ 3 }}{ 2  }   \\ 
\sec  =  \frac{1}{\cos}  =\frac{1}{ \frac{\sqrt{ 3 }}{ 2  }}   = \frac{2}{\sqrt{ 3 }}
\end{array}
$$
so we note that tan  is an odd function  
...
\cos  \left( - \frac{\pi}{4} \right)   = \frac{\sqrt{ 2 }}{2} 
  \\
\tan \frac{\sqrt{ 2 }}{2}  =  \frac{-\frac{\sqrt{ 2 }}{2}}{\frac{\sqrt{ 2 }}{2} }  =  -1
 \end{array}
$$
...
\sin \left(    -\frac{11\pi}{3} \right) = \left(   -\frac{\pi}{3}  +  \frac{\pi}{4}    \right)    \text{ the angle will spin  around 2 time because of the coterminal angle   }   \\
 =  \sin \left( \frac{\pi}{4}    \right) \in \text{ quadrant IV,reflect over of x axis of} \frac{\pi}{4}   \\

 \sin \left(   - \frac{\pi}{4}   \right)  = - \frac{\sqrt{ 2 }}{2} \\
\cos  \left( - \frac{\pi}{4} \right)   = \frac{\sqrt{ 2 }}{2} 
  \\
\sin \frac{\sqrt{ 2 }}{2}  =  \frac{-\frac{\sqrt{ 2 }}{2}}{\frac{\sqrt{ 2 }}{2} }  =  -1
 \end{array}
$$
