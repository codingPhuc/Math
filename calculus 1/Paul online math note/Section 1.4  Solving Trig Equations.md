...
$$
\begin{array}{l} 
8\tan (2x) - 5   = 3   \in  \left[ -\frac{\pi}{2} , \frac{3\pi}{2}  \right]  \\
...
$$
\frac{y}{7}  = \frac{4\pi}{3} +2\pi n  =  \frac{28\pi}{3} +14\pi n    \left\{ \text{ n } \in Z |  (-\infty , \infty )\right\} 
$$
$$
\frac{y}{7}  = \frac{2\pi}{3} +2\pi n   = \frac{14\pi}{3} +14\pi n     \left\{ \text{ n } \in Z |  (-\infty , \infty )\right\} 
$$
so there are  multiple number of solution bases on the above equation 
