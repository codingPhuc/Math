...
There are many way to write different angle on a unit. Sometime it will be $\frac{3\pi}{4}\cap \frac{{4}\pi}{3}$ that we want for a solution, sometime many more so we need  a formula for every possible solution : 
$$
