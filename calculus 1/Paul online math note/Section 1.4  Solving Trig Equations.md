...
$$
2x=  \frac{\pi}{4}  + \pi n  \implies  x  =   \frac{\pi}{8} + \frac{\pi n}{2} \left\{ \text{ n } \in Z |  (-\infty , \infty )\right\} 
$$
$$
2x =   \frac{5\pi}{4}   + \pi n  \implies  x  =      \frac{5\pi}{8}   + \frac{\pi n}{2}     \left\{ \text{ n } \in Z |  (-\infty , \infty )\right\} 
$$
so there are  multiple number of solution bases on the above equation 
