...
\sin 60  = \frac{opp}{hyp}  = \frac{\frac{\sqrt{ 3 }}{2}}{1}  = \frac{\sqrt{ 3 }}{2} \\
\cos 60  =  \frac{adj}{hyp}  = \frac{\frac{1}{2}}{1}  =  \frac{1}{2}
\end{array}
$$


| angle in degree | angle  in radian | cos 0                  | sin  0                 |
| --------------- | ---------------- | ---------------------- | ---------------------- |
| 30              | $\frac{\pi}{6}$  | $\frac{\sqrt{ 3 }}{2}$ | $\frac{1}{2}$          |
| 45              | $\frac{\pi}{4}$  | $\frac{\sqrt{ 2 }}{2}$ | $\frac{\sqrt{ 2 }}{2}$ |
| 60              | $\frac{\pi}{4}$  | $\frac{1}{2}$          | $\frac{\sqrt{ 3 }}{2}$ |
