...
\ln (s(t) )  = \ln ((t^2+1)(t+3)^{1/3}e^{3t}  - 9(t+2)^{1/2})  -  \frac{15}{2}\ln((t+3)^{1/3}(t+2)^{1/2})
\end{array}
...
$$
v(t ) =     \frac{\frac{((t +  h)^2 )e^{3(t+h) }}{ (t+h+2)^{1/2}}     -  \frac{9}{(t +h + 3)^{1/3}}  - \frac{(t^2+1)e^{3t}}{(t+2)^{1/2}}+\frac{9}{(t+3)^{1/3}}  }{}
$$
