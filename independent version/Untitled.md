...
2. to find the corresponding shift point we need  to find the x of the child graph combine with the c unit that result in the x of the parent graph $x_{c}+ u =x_{p} \text{ so } x+2=1\implies x0$   
