...
**Week 1 (2025-12-14–2025-12-20) — MATH 185 Calc 2**

You requested **6–8 hours/day**, but your accepted Deep Work blocks only allow that on **Sun/Sat** (and partly Fri). On Mon/Wed/Tue/Thu, I schedule the **maximum available** within your blocks, and keep the rest as “unscheduled time” (buffer + free time).
...
- **Objective:** Build the rigorous definition of the definite integral via upper/lower sums; explain integrability.
    
- **Why this chapter:** Your later techniques must rest on a correct definition (fixes “foundation” + “proof/explanation” weakness).
    
- **Prereqs to recall:** partitions; sup/inf; limits; continuity.
...
- **Worked examples to replicate:** compute (U(f,P)), (L(f,P)) for simple (f) on a given partition (use your HW “Supplemental” task).
    
- **Exercises set (from your course HW):** **Spivak 12:** #1 (skip vi), 6, 7, 8, 11; plus the **Supplemental** (U,L) problem for (f(x)=\sin x) on ([0,5\pi/6]) with the given partition. _(MATH-185-HW-PROBLEMS.pdf)_
    
- **Deliverable:** 1-page “Integral Foundations Sheet” + one 3-minute oral explanation of integrability.
    
- **Mastery check (timed; pass ≥80%):** 12 minutes: compute (U,L) for one function/partition + explain integrability criterion in words.
...
### Card 2 — Spivak Ch. 13 (Fundamental Theorem of Calculus support)

- **Book/edition/section:** _Calculus_, Spivak, **4th ed.**, **Ch. 13**
    
- **Objective:** State FTC cleanly and explain why “area accumulation” produces an antiderivative.
    
- **Why this chapter:** This is the bridge between _definition_ and _computation_.
    
- **Prereqs to recall:** continuity; derivative definition; Mean Value Theorem idea.
    
- **Key terms/theorems:** FTC (Part I/II), accumulation function, net change.
    
- **Core equation (for oral):**  
    [  
    \frac{d}{dx}\int_a^x f(t),dt = f(x)  
    ]  
    Plain language: If you build area up to (x), the rate the area changes at (x) equals the height (f(x)).
    
- **Worked examples to replicate:** differentiate/interpret integrals with variable upper limit; connect to antiderivatives.
    
- **Exercises set:** “Review Spivak 13 notes” as assigned in HW #2. _(MATH-185-HW-PROBLEMS.pdf)_
    
- **Deliverable:** 10-item oral drill list (FTC statements + 3 examples) recorded as bullet answers.
    
- **Mastery check:** 10 minutes: 5 FTC questions (state + apply); pass 4/5.
...
### Card 3 — Stewart 9e §7.1 (Integration by Parts)

- **Book/edition/section:** _Calculus: Early Transcendentals_, Stewart–Clegg–Watson, **9th ed.**, **§7.1**
    
- **Objective:** Derive and apply integration by parts; choose (u) strategically.
    
- **Why this chapter:** Most common Calc 2 technique; appears everywhere.
    
- **Prereqs:** product rule; basic antiderivatives.
    
- **Key terms:** LIATE heuristic, repeated parts, tabular method (if you use it).
    
- **Core equation:**  
    [  
    \int u,dv = uv-\int v,du  
    ]  
    Plain language: Trade one integral for another by reversing the product rule.
    
- **Worked examples to replicate:** 3 standard patterns: (x e^x), (x\sin x), (\ln x).
    
- **Exercises set (course HW):** **§7.1:** #1–23 (odd), 29, 35, 37, 61, 63, 65. _(MATH-185-HW-PROBLEMS.pdf)_
    
- **Deliverable:** “By-Parts Playbook” (1 page): decision rules + 6 solved-from-scratch practice attempts (no notes).
    
- **Mastery check:** 20 minutes: 4 by-parts integrals; pass ≥3/4 correct setups + ≥3 correct final forms.
...
### Card 4 — Stewart 9e §7.2 (Trigonometric Integrals)

- **Book/edition/section:** Stewart **9e**, **§7.2**
    
- **Objective:** Recognize parity/identity patterns and reduce to algebraic forms.
    
- **Why this chapter:** Fast points on exams if pattern-recognition is trained.
    
- **Prereqs:** trig identities; (u)-substitution.
    
- **Key terms:** powers of (\sin,\cos); powers of (\sec,\tan); reduction identities.
    
- **Deliverable:** a 1-page “Trig pattern chart” + 12-problem drill log.
    
- **Exercises set (course HW):**
    
    - **§7.2:** #1–37 (every other odd: 1,5,9,…) and 56, 57, 61, 63. _(HW #1)_
        
    - **Stewart §7.2:** #39, 40, 41, 45, 49. _(HW #2)_
        
- **Mastery check:** 15 minutes: 6 mixed trig integrals; pass ≥5/6 correct method choice.
...
### Card 5 — Stewart 9e §7.3 (Trigonometric Substitution)

- **Book/edition/section:** Stewart **9e**, **§7.3**
    
- **Objective:** Map (\sqrt{a^2-x^2}), (\sqrt{a^2+x^2}), (\sqrt{x^2-a^2}) to the right trig substitution and back-substitute cleanly.
    
- **Why this chapter:** Setup errors are common; mastery comes from repetition.
    
- **Prereqs:** right-triangle back-sub; trig identities.
    
- **Deliverable:** 1-page “3-case substitution sheet” + 8 problem attempts.
    
- **Exercises set (course HW):** **Stewart §7.3:** #1–29 (odd), 37. _(HW #2)_
    
- **Mastery check:** 20 minutes: 3 trig-sub integrals; pass ≥2/3 fully correct.
...
### Card 6 — Stewart 9e §7.4 (Partial Fractions)

- **Book/edition/section:** Stewart **9e**, **§7.4**
    
- **Objective:** Decompose rational functions and integrate each term correctly.
    
- **Why this chapter:** High-yield and algorithmic (good for timed exams).
    
- **Prereqs:** factoring; algebraic solving systems.
    
- **Deliverable:** “Decomposition checklist” + 10 decompositions (no integration) + 6 full integrals.
    
- **Exercises set (course HW):**
    
    - **Stewart §7.4:** #7–15 (odd). _(HW #2)_
        
    - **§7.4:** #1, 3, 5, 17–47 (odd). _(HW #3)_
        
- **Mastery check:** 25 minutes: 4 partial-fractions integrals; pass ≥3/4.
...
### Card 7 — Stewart 9e §7.7 + §7.8 (Numerical + Improper Integrals)

- **Book/edition/section:** Stewart **9e**, **§7.7–§7.8**
    
- **Objective:** Use trapezoid/Simpson rules correctly; decide convergence for improper integrals.
    
- **Why this chapter:** Common “concept + computation” exam material.
    
- **Exercises set (course HW):**
    
    - **§7.7:** #1, 7–11, 19, 20, 21. _(HW #4; calculator recommended)_
        
    - **§7.8:** #5–37 (odd). _(HW #3)_ and later #49, 51, 53. _(HW #4)_
        
- **Deliverable:** one numeric-method summary card + improper-integral decision tree.
    
- **Mastery check:** 20 minutes: 2 numerical + 2 improper; pass ≥3/4.
    
- **Estimated time:** ~4.0 h (start this week; finish next)
    

---

## B) Weekly Tasks (one-liners; gradeable)

- **Calc 2:** Build “Integral Foundations Sheet” + do Spivak 12 assigned set + supplemental (U,L) task. _Spivak 4e, Ch 12._ Why: makes later techniques rigorous. Deliverable: 1 page + 1 oral take. (**5.0 h**)
    
- **Calc 2:** FTC oral drill list + quick applications. _Spivak 4e, Ch 13._ Why: links definition ↔ computation. Deliverable: 10-item oral answers. (**2.0 h**)
    
- **Calc 2:** Integration by parts derivation + §7.1 drill set (selected HW). _Stewart 9e, §7.1._ Why: core technique. Deliverable: playbook + error log. (**4.5 h**)
    
- **Calc 2:** Trig integrals pattern training + assigned §7.2 set. _Stewart 9e, §7.2._ Why: speed points. Deliverable: pattern chart + drill log. (**4.0 h**)
    
- **Calc 2:** Trig substitution 3-case sheet + assigned §7.3 set. _Stewart 9e, §7.3._ Why: setup accuracy. Deliverable: sheet + 8 attempts. (**3.5 h**)
    
- **Calc 2:** Partial fractions algorithm + assigned §7.4 set. _Stewart 9e, §7.4._ Why: algorithmic exam staple. Deliverable: checklist + drills. (**4.0 h**)
