...
Significant figure: is used to get  the level of precision of a measurement. The result of the output have not more significant figure than the input, this is because, 
