...
order of magnitudeis the equivilent form of a values multiply by 10 to the power of n, meaning it is a different way of writing the value with the same scale. one order of magnitude mean that the e
