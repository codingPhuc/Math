...
significant figure is used to indicate a measurement uncertainty. If the input is crude the output result should be scale to match the least precise input and if input 
