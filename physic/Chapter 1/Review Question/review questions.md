...
the extra digits is fabricated digit since if the input value is crude as k sinficant digit then we must output the same power of 10 scale output to perverse precision
