...
the extra digits is fabricated digit since if the input value is crude as k sinficant digit then we must output must be same k significant digit to perverse 
