...
- Main source (spine): `Chapter_3_Zemansky (1).pdf`
    
- Spine scope: `E 3, 9, 10, 16, 24, 25, 27, 29, 31, 33; P 67`
...
- Table columns: `Concept | Spine anchor | Support #1 | Support #2 | Support #3`
...
- If the spine chapter is too large to cover cleanly in 60 concepts, cap Layer 2 at 60 and then add an “Overflow Concepts” appendix that groups remaining concepts by section with anchors
    
- The appendix must remain mapping-focused and condensed
    

Final instruction  
Map the content of the spine to other books in the project so that I know what to read to understand the chapter well.

Final questions

- Ask questions only if strictly needed