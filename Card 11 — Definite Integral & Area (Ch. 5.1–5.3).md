...
Well Rio, think of the function $f(x) =x -2$ within the interval of $[0,4]$  as a skat boarding area, where at the interval between [0,2] is an underground area, while the interval [2,4] is an above ground area both having an areas of  2 $m^2$. In normal geo
**Q4 [CON, PROC]**  
