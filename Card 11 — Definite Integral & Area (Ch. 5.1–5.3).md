...
Well Rio, think of the function $f(x) =x -2$ within the interval of $[0,4]$  as a skat boarding area, where at the interval between [0,2] is an underground area with 2 f
