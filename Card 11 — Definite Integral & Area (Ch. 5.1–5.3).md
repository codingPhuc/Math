...
well Rio, Think of it like this Think of it like you know how a skateboarding area you see have an underground area and a above ground  area. Sign intervals What's similar to that Usually whenever you want to calculate like an area of Of a skate park we would check ACT up the underground idea and the above ground area. For example, the underground areas were like 2 square root and the above brown area would be 2 square foot  into four right, but with sign interval this work different, think of it like instead of both area being positive or negative it will change based on the attribute of whether the area is underground or above ground if the area is above ground then it will be a positive addition if the area is underground then it will be a negative addition causing us to have a result equal into zero if both the above ground area and the underground area are being 0. So that is what sign interval is the of sub intervals within an interval that determine whether and area is positive or negative ? 
