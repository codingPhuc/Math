...
4. Make sure you got one point in each side of the vertex . if the parabola have two x-intercepts we already got these point by solving the quadratic equation . If it have only one or 0 x-intercept then we need to find 