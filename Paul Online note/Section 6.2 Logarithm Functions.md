...
Note that the requirement  $x>0$ is really the result of the fact that we also require $b>0$ . If you think about this it make sense , the first constrain cannot be a negative number since a positive exponent can only be created by a positive number 
