...
\begin{tikzpicture}[x=1cm,y=1cm]
	...
	\fill (    -1.5  , -4) circle (2pt) node[above left] {$(    -1.5  , -4) $};
		\fill  (  -2 ,   -2   ) circle (2pt) node[above left] {$ (  -2 ,   -2   )$};
	\fill ( -2   , -6) circle (2pt) node[above left] {$( -2   , -6) $};
    % Draw x-axis

	\draw[thick, blue] (-2,-4) ellipse [x radius=0.5, y radius=2];
...
\begin{array}{l}
x^2  + 8x  +   3y^2 -  6y  + 7   = 0    \\
x^2  +  8x + 16 - 16 + 3(y^2  - 2y +  1  -1  ) + 7 = 0  \\
(x +  4)^2  - 16 + 3(( y -  1)^2  -1  ) + 7 = 0    \\
 (x +  4)^2  - 16 +  3( y -  1)^2  -3   + 7 = 0  \\
 (x +  4)^2 +  3( y -  1)^2  -12  =  0  \\
 (x +  4)^2 +  3( y -  1)^2 = 12  \\
 \frac{(x +  4)^2}{12} +  \frac{( y -  1)^2}{4} = 1 
\end{array}
...
9(x^2 + 14x +  49  -  49) + 4 (y^2 - 8y + 16  - 16 ) + 469  =  0   \\
 9(x + 7)^2   + 4(y - 4 )^2  -441  + 4 (  - 16 ) + 469  =  0
 \frac{(x +  4)^2}{12} +  \frac{( y -  1)^2}{4} = 1 
\end{array}
