...
| $$<br>x^2 + y^2 =  1<br>$$<br> | $$<br>\begin{array}{l}<br>x^2  + (-y)^2  =  1   \\<br> x^2  + y^2  =  1  <br>\end{array}<br>$$ | $$<br>\begin{array}{l}<br>(-x)^2  + (y)^2  =  1   \\<br>x^2  + y^2  =  1  <br>\end{array}<br>$$               | we concluded tha                                                                                               |                                                                                                           |
|                                |                                                                                                |                                                                                                               |                                                                                                                |                                                                                                           |
