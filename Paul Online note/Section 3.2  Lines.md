...
a  line  is define  by  two  point that are on the line .  As  a result , in order to get the equation and graph the line we ne   . This fact will be used in serval  point  in the equation 
