...
| -0.99999 | 0.00001   |
| .000001  | 0 .999999 |
the limit approaching the value on the right equal to  1 while the limit approaching from the left equal to 0.  so the two limit doesn't match so we concluded that the left and r
