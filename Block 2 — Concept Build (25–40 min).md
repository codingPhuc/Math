...
| -0.99999 | 0.00001 |
| .000001  | 0 .     |
the limit approaching the value on the right equal the limit approaching the value on the left which is  0.  so the two limit match concluding that the limit approaching 0  is 1 
