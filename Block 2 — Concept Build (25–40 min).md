...
| -0.1  | 0.9  | 0.1   | 0.9  |
| -0.01 | 0.99 | 0.01  | 0.99 |
the two table with the limit approaching from the left for the first 2 column , and the limit approaching from the right for the last 2 column help us see that the left hand limti 
